...
public class InfiniteRoundManager : MonoBehaviour
{
    public static InfiniteRoundManager Instance { get; private set; }

    private int round;
    private int totalRounds;
    [SerializeField] private InfiniteRoundController[] rounds;
...
public class InfiniteEnemyDeathTracker : MonoBehaviour
{
