...
public class InnocentDuck : Enemy
{
    ...
    void OnCollisionEnter2D(Collision2D col) {
        //collision is a bit wonky at high speeds. I suspect what happens is the duck clips into the wall
        //and collides once and then collides again on the way back giving a wierd negative bounce that sticks
        //it to the wall.
